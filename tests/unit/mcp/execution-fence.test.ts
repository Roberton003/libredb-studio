...
describe("MCP Execution Fence", () => {
  test("permite consultas SELECT legítimas", () => {
  ...
  test("permite consultas com CTE de leitura pura", () => {
  ...
  test("rejeita instruções DDL (DROP, CREATE, ALTER, TRUNCATE)", () => {
  ...
  test("rejeita instruções DML (INSERT, UPDATE, DELETE)", () => {
  ...
  test("rejeita múltiplos statements separados por ponto e vírgula", () => {
  ...
  test("rejeita comandos disfarçados em comentários ou textos ambíguos", () => {
