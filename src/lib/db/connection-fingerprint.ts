 ...
 * (`src/lib/db/factory.ts:586`) tests exactly that flag: a switched-off tunnel is not a route at
 ...
 *   (`src/lib/db/factory.ts:586-593`) REWRITES `host` and `port` to the tunnel's local endpoint
